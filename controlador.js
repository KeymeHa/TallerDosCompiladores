      ...
      case 2:
        ...
        if(!esValido){
            ...
            else
            {
                ...
                {
                    console.log(arrayDeCaracteres[i] + " " + i );
                    ...
                    {
                        regex = i == 1 ? /^[a-zA-Z]$/ : /^[a-zA-Z]+[a-zA-Z0-9_]$/ ;
                    ...
                    if(i == tam)
                    {
                        ...
                        esValido = arrayDeCaracteres[arrayDeCaracteres.length] == arrayDeCaracteres[0] ? esValido : esValido;
